...
import com.androidcourse.shoppinglistkotlin.Data.ProductRepository
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        ...
        // here we get the list from our database starting a Coroutine
    private fun getShoppingListFromDatabase() {
        ...
        // validation things that the fields must be filled
        ...
        if (validateFields()) {
            mainScope.launch {
                ...
                withContext(Dispatchers.IO) {
                    //we insert the product data into our database user the repo
    ...
    private fun createItemTouchHelper(): ItemTouchHelper {
        ...
        return ItemTouchHelper(callback)
            ...
            //Delete the items form the list
